...
#defining ASCII characters and width of output
ASCII_CHARS = "@%#*+=-:. " 
WIDTH = 100
...
out = cv2.VideoWriter('ascii_output.avi', fourcc, 10, (800, 600)) 
...
#Convert AVI to MP4
subprocess.run([
    "ffmpeg", "-y", "-i", "ascii_output.avi",
    "-c:v", "libx264", "-preset", "fast", "-crf", "23",
    "ascii_output.mp4"
])

#Preview the MP4 video automatically
subprocess.run(["open", "ascii_output.mp4"])